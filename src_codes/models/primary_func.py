...
unet_1d_weights_path = '/home/CAMPUS/hdasari/apebench_experiments/ks_2d/notebooks/unet_1d_weights_biases.pth'
...
class PrimaryNetwork(nn.Module):
    ...
    def forward(self, x):
        ...
        # encoder_part
        enc1 = self.unet_blocks[0](x, self.zs_unetblocks[0](self.unet_block_hope))
        # print("check-1 passed")
        enc2 = self.unet_blocks[1](self.pool1(enc1), self.zs_unetblocks[2](self.unet_block_hope), self.zs_unetblocks[1](self.unet_block_hope))
        # print("check-2 passed")
        enc3 = self.unet_blocks[2](self.pool2(enc2),self.zs_unetblocks[4](self.unet_block_hope),  self.zs_unetblocks[3](self.unet_block_hope))
        # print("check-3 passed")
        enc4 = self.unet_blocks[3](self.pool3(enc3), self.zs_unetblocks[6](self.unet_block_hope), self.zs_unetblocks[5](self.unet_block_hope))
        # bottleneck
        bottleneck = self.unet_blocks[4](self.pool4(enc4),self.zs_unetblocks[8](self.unet_block_hope) ,self.zs_unetblocks[7](self.unet_block_hope))
        # print("check-4 passed")
        # decoder_part
        w, b = self.zs_upconv[0](self.unet_upconv_hope)
        # print("check-5 passed")
        dec4 = self.upconv[0](bottleneck, w, b)
        # print("check-6 passed")
        # print(f"dec4 shape: {dec4.shape}, enc4 shape: {enc4.shape}")
        dec4 = torch.cat((dec4, enc4), dim=1)
        dec4 = self.unet_blocks[5](dec4, self.zs_unetblocks[10](self.unet_block_hope),self.zs_unetblocks[9](self.unet_block_hope))
        # print("check-7 passed")
        w, b = self.zs_upconv[1](self.unet_upconv_hope)
        dec3 = self.upconv[1](dec4, w, b) 
        dec3 = torch.cat((dec3, enc3), dim=1)
        dec3 = self.unet_blocks[6](dec3, self.zs_unetblocks[12](self.unet_block_hope),self.zs_unetblocks[11](self.unet_block_hope))
        w, b = self.zs_upconv[2](self.unet_upconv_hope)
        dec2 = self.upconv[2](dec3, w, b)
        dec2 = torch.cat((dec2, enc2), dim=1)
        dec2 = self.unet_blocks[7](dec2, self.zs_unetblocks[14](self.unet_block_hope),self.zs_unetblocks[13](self.unet_block_hope))
        w, b = self.zs_upconv[3](self.unet_upconv_hope)
        dec1 = self.upconv[3](dec2, w, b)
        dec1 = torch.cat((dec1, enc1), dim=1)
        dec1 = self.unet_blocks[8](dec1, self.zs_unetblocks[16](self.unet_block_hope),self.zs_unetblocks[15](self.unet_block_hope))
        # final layer
